...
struct CustomAlertWithImage: ViewModifier {
...
extension View {
    func customAlertWithImage(isPresented: Binding<Bool>, hideCancel: Bool, message: String, title: String, isShowImage: Bool, imageName: String, onConfirm: @escaping () -> Void, onCancel: @escaping () -> Void) -> some View {
        self.modifier(CustomAlertWithImage(isPresented: isPresented, hideCancel: hideCancel, message: message, title: title, isShowImage: isShowImage, imageName: imageName, onConfirm: onConfirm, onCancel: onCancel))
    }
}
